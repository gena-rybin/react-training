    ...
    render() {
        return (
            <div id={'actionBar'}>
                ...
                <div className={'action-container'}>
                    <svg id={'editButton'} xmlns="http://www.w3.org/2000/svg" xmlnsXlink={'http://www.w3.org/1999/xlink'} version="1.1" x="0px" y="0px" viewBox="0 0 55.25 55.25"
                         style={{'enableBackground':'new 0 0 55.25 55.25'}} xmlSpace={'preserve'} width="40px" height="40px">
